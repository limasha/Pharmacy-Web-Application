...
<jsp:include page="header.jsp" />
 ...
 <div class="container">
  <spring:url value="/pharmacy/editMedicine/{id}" var="addURL" />
  <h2 class="main-title">Update Medicine</h2><br>
  
  <form:form  modelAttribute="medicineUpdateForm"  method="post" action="${addURL}" cssClass="form" >
   <form:hidden path="id"/>
